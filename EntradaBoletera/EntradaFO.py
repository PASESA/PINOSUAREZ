...
# in3 = 13                      #gpio13,pin33,entrada barrera
...
# -----------------------------------
    ...
    def check_inputs(self):
        ...
        # if io.input(loop):
        #         self.loopDet.config(text = "<S<A", background = '#CCC')
        #         io.output(out1,1)
...
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$impresion    $$$$$$$$$$$$$$$$$$$
        ...
        #esta es la impresora con sus valores que se obtienen con lsusb
        ...
        p.text('Marca:_____________________ \n')
        p.set(align="left")
        ...
        p.set("center")
        p.text("BOLETO LOCALIZACION\n")
        p.set(height=2, align='right')
        folioZZ=('FOLIO ' + masuno)
        p.text(folioZZ+'\n')
        p.set("center")
        p.text('Entro: '+horaentrada[:-3]+'\n')
        ...
        p.text("Lugar:______________________ \n")
        p.text("--------------------------------------\n")
        p.cut()        
        ...
        self.Placa.set('')
        self.entryPlaca.focus()
        self.label_informacion.config(text="Entrada registrada")
